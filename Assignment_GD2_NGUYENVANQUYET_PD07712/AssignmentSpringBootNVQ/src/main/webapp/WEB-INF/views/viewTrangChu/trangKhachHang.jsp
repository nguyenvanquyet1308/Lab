...
<body>
	...
	<div id="wrapper">
		...
		<form:form action="/trangchu/product" modelAttribute="product">
						...
						<div class="card">
							...
							<div class="mb-5 d-flex justify-content-around">
								...
								<div class="icon-cart">
									...
									<a class=" show-modal" href="/trangchu/${item.productId}">
				...
				<nav aria-label="Page navigation" class="text-center;">
					<ul class="pagination">
						<li class="page-item"><a class="page-link"
							href="/trangchu?p=0">First</a></li>
						<li class="page-item"><a class="page-link"
							href="/trangchu?p=${page.number-1}">Previous</a></li>
						<c:forEach var="i" begin="0" end="${page.totalPages-1}">
							<li
								class="page-item <c:if test="${i eq page.number}">active</c:if>">
								<a class="page-link" href="/trangchu?p=${i}">${i+1}</a>
							</li>
						</c:forEach>
						<li class="page-item"><a class="page-link"
							href="/trangchu?p=${page.number+1}">Next</a></li>
						<li class="page-item"><a class="page-link"
							href="/trangchu?p=${page.totalPages-1}">Last</a></li>
					</ul>
				</nav>
					...
					$('.show-modal').on(
							...
							function(event) {
								...
								$.get(href, function(Product, status) {
                                    ...
                                    $('#IdCuaProduct').attr('href',"/trangchu/gioHang/"+ Product.productId);
								});
