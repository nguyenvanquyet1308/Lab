		...
		<div class="header">
			<div id="header">
				...
				<div id="menu">
					...
					<div class="item">
						<a href="/trangchu/dangNhap">Đăng Nhập</a>
					</div>
					<div class="item">

						<a href="/trangchu/dangKy">Đăng Ký</a>
					</div>
					<div class="item">
				...
				<div id="actions">
					<div class="item">
						...
						<ul class="dropdown-menu dropdown-menu-end"
							...
							<li><a class="dropdown-item text-body " href="/trangchu/hoSo">Hồ sơ</a></li>
							<li><a class="dropdown-item text-body " href="/trangchu/dangXuat">Đăng Xuất</a></li>
							
						</ul>

					</div>
					<div class="item">
						<a href="/trangchu/gioHang"> <img
