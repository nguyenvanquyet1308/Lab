...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="/admin/QLUser" class="nav-link">Quản lý Người Dùng</a>
        <a href="/admin/QLCategory" class="nav-link">Quản lý Đơn Hàng</a>
        <a href="/admin/QLCategory" class="nav-link">Thống kê</a>
    </div>
